...
def experiment_1_1(n_vals, theta_vals, alphas, repeats=10, results_filename=None, seed=0, num_bootstrap_samples=10_000, verbose=True):
    # generate the data
    ...
    # Calculate intervals with timing
    ...
    if verbose: print("Calculating intervals with clopper-pearson...", end=' ')
    start = time.time()
    ...
    if verbose: print("Calculating intervals with bootstrap...", end=' ')
    start = time.time()
